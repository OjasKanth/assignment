...
class App extends React.Component {
  ...
  render() {
    ...
    enableTooltip={true} tooltipTemplate={this.cardTooltipTemplate}>
      <ColumnsDirective>
      <ColumnDirective headerText='No priority' keyField="Open"></ColumnDirective>
      <ColumnDirective headerText='Urgent' keyField="In Progress"></ColumnDirective>
      <ColumnDirective headerText='High' keyField="Review"
      minCount={1} maxCount={3}></ColumnDirective>
      <ColumnDirective headerText='Medium' keyField="Testing"
      minCount={5} maxCount={8}></ColumnDirective>
      <ColumnDirective headerText='Low' keyField="Close"></ColumnDirective>
      </ColumnsDirective>
    </KanbanComponent>);
  }
}
